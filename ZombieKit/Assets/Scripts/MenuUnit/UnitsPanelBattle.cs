...
public class UnitsPanelBattle : MonoBehaviour {
	...
	private void CreateStar(Vector3 gridPos)
	{
		...
		{
		case -1:
			GameObject StarO = (GameObject)Instantiate (spawnPointStar0, gridPos, Quaternion.identity);
			break;
		case 0:
			GameObject StarI = (GameObject)Instantiate (spawnPointStarI, gridPos, Quaternion.identity);	
			break;
		case 1:
			GameObject StarII = (GameObject)Instantiate (spawnPointStarII, gridPos, Quaternion.identity);	
			break;
		case 2:
			GameObject StarIII = (GameObject)Instantiate (spawnPointStarIII, gridPos, Quaternion.identity);	
			break;	
		case 3:
