	...
	*/
	...
	private void NextArrow()
	{
		...
		if (!itemSeen[0])
		{
			...
			fullCharArray =("Zombie Strategy Kit Instructions:\n" +
				"Since this is the first time you are running it,\n" +
				"we will try to walk you through some of the features.\n" +
				"(See and edit these instructions in GhostHelper.cs)").ToCharArray();
